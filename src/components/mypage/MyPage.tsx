...
const MyPage = () => {
  return (
    <Container>
      <Paper elevation={0} sx={{ display: "flex", justifyContent: "center", height: 392, mb: 1 }}>
        <Box>
          <Avatar src="/images/profile.png" sx={{ width: 150, height: 150 }} />
          <Typography>NickName</Typography>
          <Typography>Amet minim mollit non deserunt ullamco est sit aliqua dolor do </Typography>
        </Box>
      </Paper>
      <Box display="flex">
